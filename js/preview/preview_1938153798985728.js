...
function onSDKLoadSucceeded(viewMetaData) {
    if (viewMetaData.viewType == "3DView") {
        ...
        viewer.addEventListener(Glodon.Bimface.Viewer.Viewer3DEvent.ViewAdded, function () {
            ...
            webUtils.getFile('../../data/1938153798985728/space.json', function (d) {
                viewer.createRoom(d, 3300, webUtils.guid(), webUtils.fromHexColor("#708090", 0.45), webUtils.fromHexColor("#778899", 1));
            });
