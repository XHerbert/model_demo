...
function onSDKLoadSucceeded(viewMetaData) {
    if (viewMetaData.viewType == "3DView") {
        ...
        viewer.addEventListener(Glodon.Bimface.Viewer.Viewer3DEvent.ViewAdded, function () {
            ...
            viewer.setBackgroundColor(new Glodon.Web.Graphics.Color(46, 64, 84, 1));
            ...
            // 建筑
            viewer.overrideComponentsColorByObjectData([{ "specialty": "建筑" }], new Glodon.Web.Graphics.Color('#1E90FF', 1));
            // viewer.overrideComponentsColorByObjectData([{ "specialty": "建筑" }], new Glodon.Web.Graphics.Color(185, 185, 185, 255));

            //手动调整颜色
            viewer.overrideComponentsColorByObjectData([{ "family": "静压箱组4" }, { "family": "静压箱组" }, { "family": "静压箱" }, { "family": "卧式暗装风机盘管" }], new Glodon.Web.Graphics.Color(255, 198, 10, 1));

            // 区域 
            viewer.overrideComponentsColorById(["1896419529082976.1089007"], new Glodon.Web.Graphics.Color(66, 199, 255, 1));

            //地面
            viewer.overrideComponentsColorByObjectData([{ "family": "楼板" }], new Glodon.Web.Graphics.Color(29, 86, 156, 1));
